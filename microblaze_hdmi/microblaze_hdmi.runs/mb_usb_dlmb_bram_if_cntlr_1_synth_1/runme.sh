...
HD_PWD='C:/Users/alexa/viv_22_proj/microblaze_hdmi/microblaze_hdmi.runs/mb_usb_dlmb_bram_if_cntlr_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_usb_dlmb_bram_if_cntlr_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_usb_dlmb_bram_if_cntlr_1.tcl
