...
#
# Generated by export_simulation on Fri Oct 31 13:02:10 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './mb_usb_hdmi_top.sh' script.

./mb_usb_hdmi_top.sh -reset_run
...
./mb_usb_hdmi_top.sh -noclean_files

For more information on the script, please type './mb_usb_hdmi_top.sh -help'.
